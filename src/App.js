...
import { HomeCareProvider } from "./context/HomeCareContext";
        ...
        <Routes>
          <Route element={<Layout />}>
            ...
            {/* home care routes */}
              ...
              <Route path="/rhomboid/home-care" element={<HomeCareProvider ><HomeCareLayout /></HomeCareProvider>}>
                ...
                <Route path="find-care/:id" element={<FindCare />} />
                

              
                <Route
                  path="find-care/:id/confirmation"
